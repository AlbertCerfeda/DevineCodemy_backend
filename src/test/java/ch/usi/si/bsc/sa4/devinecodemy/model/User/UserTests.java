...
public class UserTests {
    ...
    void testConstructor() {
        User user = new User("an id", "a name", "a username", "an email", "an avatar", "a bio");
    ...
    void testToUserDTO() {
        ...
        User user2 = new User("another id", "another name", "another username", "another email", "another avatar", "another bio");
