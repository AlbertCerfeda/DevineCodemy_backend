...
public class LevelControllerTests {
    ...
    void setup() {
        ...
        level2 = new Level("level 2", "description of 2", 2, EWorld.PURGATORY, 1,
                ...
                new Robot(1, 1, EOrientation.UP), List.of(ECategory.COLLECT_COIN),
        ...
        level3 = new Level("level 3", "description of 3", 3, EWorld.PURGATORY, 2,
                ...
                new Robot(1, 1, EOrientation.UP), List.of(ECategory.MOVE_FORWARD, ECategory.COLLECT_COIN),
        ...
        level4 = new Level("level 4", "description of 4", 4, EWorld.PURGATORY, 4,
                ...
                new Robot(1, 1, EOrientation.UP), List.of(ECategory.TURN_RIGHT, ECategory.MOVE_FORWARD, ECategory.COLLECT_COIN),
        ...
        level5 = new Level("level 5", "description of 5", 5, EWorld.PURGATORY, 6,
                ...
                List.of(ECategory.COLLECT_COIN, ECategory.MOVE_FORWARD, ECategory.TURN_LEFT, ECategory.TURN_RIGHT),
