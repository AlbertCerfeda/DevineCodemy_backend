...
public class LevelValidationTests {
    ...
    class AfterCreationTests {
        ...
        public void testAddAnimation() {
            levelValidation.addAnimation(SAnimation.EMOTE_DANCE);
            assertTrue(levelValidation.getAnimations().contains(SAnimation.EMOTE_DANCE),
        ...
        class AfterAddingAnimationAndErrorTests {
            ...
            public void testClearAnimations() {
                ...
                assertFalse(levelValidation.getAnimations().contains(SAnimation.EMOTE_DANCE),
            ...
            public void testEquals() {
                ...
                assertNotEquals(levelValidation,levelValidation1,
                        "the comparison of an object with one containing different animations"+
                                " returns true");
                levelValidation1.addAnimation(SAnimation.EMOTE_DANCE);
                ...
                levelValidation1.addAnimation(SAnimation.JUMP);
                assertNotEquals(levelValidation,levelValidation1,
                        "the comparison of an object with one containing different animations " +
                                " returns true");
